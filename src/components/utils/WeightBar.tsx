...
const COLORS = {
  ...
  durabilityColor: [39, 174, 96], // Green (Nephritis)
};
    ...
    () =>
      durability
        ? percent < 50
          ...
          : colorMixer(COLORS.durabilityColor, COLORS.accentColor, percent / 100)
        : percent > 50
        ? colorMixer(COLORS.primaryColor, COLORS.accentColor, percent / 100)
        : colorMixer(COLORS.accentColor, COLORS.durabilityColor, percent / 50),
    [durability, percent]
  );
